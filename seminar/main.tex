...
\input{cover/prva-stranica}
\pagenumbering{gobble}
\clearpage
\newpage

\input{cover/druga-stranica}
\pagenumbering{gobble}
\clearpage
\newpage

% Uključivanje PDF stranica
\includepdf[pages=-]{cover/Izjava_o_akademskoj_cestitosti.pdf}
...
\input{projektni_zadatak/projektni_zadatak}
\newpage

\input{odabir_i_analiza_skupa_podataka/odabir_i_analiza_skupa_podataka}
\newpage

\input{relacijski_model_podataka/relacijski_model_podataka}
\newpage

\input{dimenzijski_model_podataka/dimenzijski_model_podataka}
\newpage

\input{etl_proces/etl_proces}
\newpage

\input{olap_analiza/olap_analiza}
\newpage
